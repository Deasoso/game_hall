export default {
  login: {
    ...
    p_email1: 'A verification code will be sent to your new email address, please check it.',
    p_email2: 'Verified email',
    p_mobile: "Please enter the phone number",
    p_pwd: "Please enter a password",
    p_fund: "Please enter a fund password",
    f_simple: "The fund password is too simple. please re-enter it",
    p_confirmPwd: "Please confirm the password",
    p_vcode: "Please enter the verification code",
    get_code: "Get code",
    rem_pwd: "Remember password",
    login: "Login",
    noaccount: "No Coinwow account yet?",
    register: "Sign Up",
    forget_pwd: "Forgot password?",
	kfbz: 'Customer service help',
    ...
    r_mobile: "Mobile",
    r_email: "Mailbox",
    r_hasaccount: "Existing Coinwow account",
    r_next: "Next step",
    ...
    p_invitecode: "Invitation code（optional）",
    ...
    e_dealPwd: "transaction password",
  ...
  collect: {
    ...
    p_reason: "Reject reason",
    bank: "Opening bank",
    p_bank: "Please enter account bank",
    no: "Bank account",
    p_no: "Please enter the bank card number",
    bank_adress: 'Bank branch',
    p_bank_adress: 'Please enter the name of the account opening branch',
    ...
    identityVerification: 'Under review',
    authSuccess: 'Certified',
    z_bank: 'Account opening sub branch',
    p_bankname: 'Please enter the name of the opening branch'
  },
  bind: {
	  notBindAdres:"No linked withdrawal account",
  ...
  authentication: {
    ...
    copy_key:'Copy key',
    restgo1:'After scanning, please enter the verification code for verification. ',
    restgo2: 'Add your email address and current key to bind. ',
    restgo3:'Please enter the verification code after binding',
    authentication_phone: 'Authentication phone',
    restmobile1: 'Please enter your mobile number',
    restmobile2: 'A verification code will be sent to your mobile phone, please check it. ',
    zj: "Certificate number"
  },
  home: {
	  
	huobi: 'Houbi Official recharge channel',
	vip: 'VIP Customer Service',
	opentg: 'Click the button below to access VIP customer service',
	bian: 'Biance Official recharge channel',
	coin: 'Coincola Official recharge channel',
    coinbase: 'Coinbase official recharge channel',
    kraken: 'Kraken official recharge channel',
    legal: "Fiat",
    ...
    welcome: "Welcome to Coinwow",
    myshop: "Personal stores",
    myshare: "My sharing links",
    contactAcceptor: 'Service',
    logout: "Logout",
    detail: "Details",
    up: "Pull up loading",
	...
	txtd: 'Withdrawal channel',
	qxzcxbz: 'Please select the currency for recharging',
	qxztxbz: 'Please select the withdrawal currency',
	IEO: 'IEO',
    zx: 'Optional',
    sg: 'Purchase',
    ieo1: 'IEO',
  ...
  assets: {
    ...
    transfer: "Transfer",
    shanyue: 'Exchange',
    shanyue_record: 'Exchange record',
    shanyue_direction: 'Direction',
    shanyue_from: 'Transfer Out',
    shanyue_to: 'Transfer In',
    shanyue_amount: 'Amount',
    ...
    recharge_number_placeholder: 'Please enter quantity',
    wallet_address: 'Wallet address',
    wallet_address_placeholder: 'Please enter wallet address',
    submit: 'Submit',
    ...
    c_tip10: 'This address is your latest recharge address. When the system receives the recharge, it will be automatically entered into the account. The transfer needs to be confirmed by the entire blockchain network. After 1 network confirmation, it will arrive at the account. When 10 network confirmations are reached, your ',
    c_tip11: ' will be automatically deposited into the account',
    c_tip12: 'Please send only ',
    c_tip13: ' to this address, sending other digital currencies to this address will cause permanent loss',
    copy_success: "Copy success",
    copy_err: "Copy failed",
    mentionaddr: "Ticket Address",
    mention0: 'Important Tips',
    mention1: 'Treatment time is about 0-24 hours. ',
    mention2: 'At present, it only supports USDT/ETH/BTC currency. ',
    mention3: 'After submitting the application for bill of payment, the funds belong to the temporary hosting of the system because the withdrawal is in progress, because the network congestion during the transfer process. The funds are temporarily custody, which does not mean that you lose abnormal assets or assets. ',
    mention4: 'After submitting the application of the withdrawal from 0-24 hours after the application of the withdrawal of the dollar. ',
    mention5: 'Asset security attention',
    mention6: 'Do not disclose your password or SMS or email to anyone. ',
    mention7: 'Don\'t call anyone who claims to be the customer service of the platform. ',
    mention8: 'Do not transfer money to anyone who claims to be a platform person. ',
    ...
    p_maxsum: 'The number of inputs is wrong',
    p_yebz: 'Insufficient balance',
    p_shanyue: 'Please choose a different currency',
    from: "From",
    to: "To",
    p_memo: 'please enter memo',
    xiaji: 'subordinate',
	convert:'exchange',
	convertNumber:'Exchange quantity',
	convertUSDT:'Can be obtained',
	creditcard:'credit card',
	topup:'Quickly buy coins',
	re_mark:'Remarks (optional)',
	tijiao:'submit',
	credit_score:'Credit score',
	recharge_money: 'Recharge amount',
	recharge_money_placeholder: 'Please enter the recharge amount',
  },
  legal: {
    legal: "Legal currency",
    ibuy: "I want to buy",
  ...
  cun: {
    title: 'Pool Lockout',
    notice: "Deposit treasure interest income is hot. Click to enter",
  ...
  ieo: {
    ieo: 'Currency',
    pledge_currency:'Pledge currency',
    pledge_cycle:'Pledge cycle',
    composite_interest_rate:'Composite interest rate',
    purchase_quantity:'Purchase quantity',
    join_now:'Join now',
    project_introduction:'Project Introduction',
    currency_available_assets:'Currency Available Assets',
    min_amount:'Minimum amount',
    max_amount:'Maximum amount',
    notStarted: 'Not started',
    subscriptioning: 'Subscription',
    ieoEnd: 'End of subscription',
    unableToPurchase: 'Non subscription status, unable to purchase',
    subscription: 'Apply for the purchase',
    convertible: 'Convertible',
    issuePrice: 'Issue price',
    totalIssuance: 'Total issuance',
    subscriptionCycle: 'Subscription cycle',
    preheat: 'Preheat',
    ieoDetail: 'Project details',
    ieoEndTime: 'End time',
    ieoNumber: 'You can enter the number of subscriptions',
	rate: 'Daliy rate',
	days: 'Lock days',
	minNumber: 'Single limit',
	recordTitle: 'Subscription record',
	myMiner: 'Order Record',
	title: 'Contract',
  ...
  currency: {
		...
		passed: 'Passed',
		white_papar: 'Project White Paper',
	},
}