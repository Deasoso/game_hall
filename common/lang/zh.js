export default {
	login: {
		...
		p_pwd: '请输入密码',
		p_fund: "请输入支付密码",
		f_simple: "支付密码太简单了，请重新输入",
		p_confirmPwd: '请确认密码',
		p_vcode: '请输入验证码',
		get_code: '获取验证码',
		rem_pwd: '记住密码',
		login: '登录',
		noaccount: '还没有Coinwow账号？',
		register: '注册',
		forget_pwd: '忘记密码？',
		kfbz: '客服帮助',
	...
	collect: {
		...
		up_cardf: '上传身份证或护照反面',
		up_cardhand: '上传手持身份证',
		identityVerification: '审核中',
		authSuccess: '已认证',
		z_bank: '开户支行',
		p_bankname: '请输入开户支行名称'
	},
	bind: {
		notBindAdres:"没有绑定提现账号",
		bindAddr: '绑定提币地址',
		cur_select: '当前选择币种',
		addr: '提币地址',
		codeauth: '交易密码',
	...
	assets: {
		...
		recharge_number_placeholder: '请输入数量',
		wallet_address: '钱包地址',
		wallet_address_placeholder: '请输入钱包地址',
		submit: '提交审核',
		c_tip1: '请勿向上述地址充值任何非',
		c_tip2: '否则资产将不可找回',
